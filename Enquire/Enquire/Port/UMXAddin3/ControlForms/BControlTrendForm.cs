...
namespace Compucare.Enquire.Legacy.UMXAddin3.ControlForms
{
    public partial class BControlTrendForm : Form
    {
        ...
        public BControlTrendForm(int type)
        {
            ...
            trendStyleBox.SelectedIndex = 2;


            prev6.Visible = false;
            tlbButton.Visible = true;
        ...
        {
            if (trendStyleBox.SelectedIndex == 2)
                tlbButton.Visible = true;
            else
                tlbButton.Visible = false;
        ...
        {
            if (type == 1) tlbForm.setPercentDiff("Werte");
            tlbForm.ShowDialog();
            Preview();
        }
