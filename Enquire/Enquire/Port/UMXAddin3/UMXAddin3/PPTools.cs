...
namespace UMXAddin3
{
    class PPTools
    {
        ...
        public String NPS(Question q, Evaluation eval2)
        {
            ...
            Question pqn = q; //
            float pcnt1 = pqn.GetAnswerPercentByPerson(0, eval, ps);
            float pcnt3 = pqn.GetAnswerPercentByPerson(2, eval, ps);
            float pcnt4 = pqn.GetAnswerPercentByPerson(3, eval, ps);
            float pcnt5 = pqn.GetAnswerPercentByPerson(4, eval, ps);
        ...
        public ArrayList ComputeTag()
        {
            ...
            float apcnt = q.GetAnswerPercentByPerson(answer, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
            ...
            {
                float vapcnt = q.GetAnswerPercentByPerson(a, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
        ...
        public string Comparetlnps()
        {
            try
            {
                ...
                float pcnt1 = q1.GetAnswerPercentByPerson(0, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
                float pcnt3 = q1.GetAnswerPercentByPerson(2, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
                float pcnt4 = q1.GetAnswerPercentByPerson(3, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
                float pcnt5 = q1.GetAnswerPercentByPerson(4, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);

                //=nps
                double nps1 = (pcnt1 - (pcnt3 + pcnt4 + pcnt5));

                 pcnt1 = q2.GetAnswerPercentByPerson(0, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
                 pcnt3 = q2.GetAnswerPercentByPerson(2, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
                 pcnt4 = q2.GetAnswerPercentByPerson(3, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
                 pcnt5 = q2.GetAnswerPercentByPerson(4, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
        ...
        public string IdivtlNps()
        {
            try
            {
                ...
                float pcnt1 = pqn.GetAnswerPercentByPerson(0, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
                float pcnt3 = pqn.GetAnswerPercentByPerson(2, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
                float pcnt4 = pqn.GetAnswerPercentByPerson(3, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
                float pcnt5 = pqn.GetAnswerPercentByPerson(4, eval, eval.CombinedPersons[Int32.Parse(dat[4])]);
