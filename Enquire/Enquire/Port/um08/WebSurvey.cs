...
//			CSS = new StyleSheet();
		...
		public void Create()
		{
			string ddir = Output.GetAppPath() + "websurvey/";
		...
		public void Connect()
		{
			...
			{
				System.Windows.Forms.MessageBox.Show("Die FTP-Verbindung konnte nicht hergestellt werden. Bitte versuchen Sie es erneut.", "Verbindungsfehler");
			}
