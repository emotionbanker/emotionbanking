...
{
	public class DialogBenchmark : DialogTemplate
	{
		...
		public DialogBenchmark(Evaluation eval, Benchmarking bench)
		{
			this.bench = bench;
			this.eval = eval;
		...
		{
			ResourceManager resources = new ResourceManager(typeof(DialogBenchmark));
