...
namespace compucare.Enquire.Legacy.Umfrage2Lib.PieChart {
	/// <summary>
    ...
    public class PieSlice : Object, IDisposable {
        ...
        /// </returns>
        public PointF PeripheralPoint(float xCenter, float yCenter, float semiMajor, float semiMinor, float angleDegrees) {
        ...
        ///   Actual start angle.
        /// </summary>
        public   float         m_actualStartAngle;
        /// <summary>
        ///   Actual sweep angle.
        /// </summary>
        public   float         m_actualSweepAngle;
        /// <summary>
        ///   Color of the surface.
        /// </summary>
        public   Color         m_surfaceColor = Color.Empty;
        /// <summary>
        ...
        /// </summary>
        public PointF        m_centerBelow;
        /// <summary>
        ///   <c>PointF</c> on the periphery corresponding to the start cut 
        ///   side.
        /// </summary>
        public PointF        m_pointStart;
        /// <summary>
        ///   <c>PointF</c> on the periphery corresponding to the start cut 
        ///   side.
        /// </summary>
        public PointF        m_pointStartBelow;
        /// <summary>
        ///   <c>PointF</c> on the periphery corresponding to the end cut 
        ///   side.
        /// </summary>
        public PointF        m_pointEnd;
        /// <summary>
        ///   <c>PointF</c> on the periphery corresponding to the end cut 
        ///   side.
        /// </summary>
        public PointF        m_pointEndBelow;
        /// <summary>
