...
namespace compucare.Enquire.Legacy.Umfrage2Lib.PieChart {
	...
	public class PieChart3D	: IDisposable {
        ...
        public virtual void PlaceTexts(Graphics graphics) {
            ...
            foreach (PieSlice slice in m_pieSlices) 
			{
				//Console.WriteLine("placing " + slice.Text);
        ...
        protected virtual void InitializePieSlices() {
            ...
            for (int i = 0; i < m_values.Length; ++i) {
				...
				if (m_values[i] > 5)
					slice.Text = Math.Round(m_values[i],1).ToString() + "%";
				else
					slice.Text = "";
        ...
        /// </summary>
        public decimal[]     m_values = new decimal[] {};
        /// <summary>
        ///   Array of colors used for rendering.
        /// </summary>
        public Color[]       m_sliceColors = new Color[] {
                                                            Color.Red,
                                                            Color.Green,
                                                            Color.Yellow,
                                                            Color.Blue,
        ...
        /// </summary>
        protected Font          m_font = Control.DefaultFont;
        /// <summary>
