...
namespace umfrage2
{
	public class OutputFormRank : DialogTemplate
	{
		...
		public OutputFormRank(Evaluation eval)
		{
			Set(eval, true, new Ranking(eval));
		}

		public OutputFormRank(Evaluation eval, bool single)
		{
            Set(eval, single, new Ranking(eval));
		}

		public OutputFormRank(Evaluation eval, bool single, Ranking avg)
		{
			Set(eval, single, avg);
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(OutputFormRank));
			...
			this.QBox.TabIndex = 52;
			// 
			// FlopsBox
			// 
			this.FlopsBox.Location = new System.Drawing.Point(368, 376);
			this.FlopsBox.Name = "FlopsBox";
			this.FlopsBox.Size = new System.Drawing.Size(176, 24);
			this.FlopsBox.TabIndex = 61;
			...
			this.Controls.Add(this.FlopsBox);
		...
		private void FlopsBox_CheckedChanged(object sender, System.EventArgs e)
		{
			Preview();
		}
