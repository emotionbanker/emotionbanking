...
{
    public delegate void ChangeOrderEventHandler(ListViewEx source);
	...
	public class ListViewEx : ListView
	{
        ...
        public event ChangeOrderEventHandler OrderChanged;
        ...
        public object SelectedItem
        {
            ...
            set
            {
                foreach (ListViewItem lwi in Items)
                {
                    lwi.Selected = (lwi.Tag == value);
                }
            }
        }
		...
		public new SortOrder Sorting
		{
			...
			set
			{
				base.Sorting = System.Windows.Forms.SortOrder.None;
			}
		}
