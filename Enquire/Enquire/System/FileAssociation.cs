	...
	public class FileAssociation {
        ...
        public static void Register(string extension)
        {
            try
            {
                ...
                fa.ContentType = "application/umfrageverwaltung";
                fa.FullName = "Umfragedaten";
                fa.ProperName = extension.ToUpper() + " File";
                fa.AddCommand("open", System.Windows.Forms.Application.ExecutablePath + " %1");
                fa.Create();
            }
            catch
            {
                Console.WriteLine("[file association]\t["+extension+"]\tregistry access failed - vista?");
            }
        }
